...
All functions return a tibble (or a list of tibble). To get information about columns [check the official API documentation](https://www.tumblr.com/docs/en/api/v2)
...
See the official [CRAN page](https://doi.org/10.32614/CRAN.package.Rtumblr) for further information about technical details.
